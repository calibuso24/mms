...
-- ALTER TABLE source.tblprojectsite ADD COLUMN IF NOT EXISTS party_id BIGINT;
-- ALTER TABLE source.tblprojectsite ADD COLUMN IF NOT EXISTS contact_id BIGINT;

-- ALTER TABLE source.tblsupplier ADD COLUMN IF NOT EXISTS party_id BIGINT;
-- ALTER TABLE source.tblsupplier ADD COLUMN IF NOT EXISTS contact_id BIGINT;
...
-- UPDATE source.tblprojectsite
-- SET party_id = nextval('party_id_seq'),
