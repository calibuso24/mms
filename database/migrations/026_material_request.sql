...
CREATE TABLE material_request (
    ...
    ceo_approved_by BIGINT REFERENCES account(account_id),
...
CREATE INDEX IF NOT EXISTS idx_material_request_requested_by_account_id ON material_request(requested_by_account_id);
