...
router.post('/:id/items', requirePermission('Purchase Order', 'UPDATE'), (req, res, next) => controller.addPurchaseOrderItem(req, res, next));
router.put('/:id/items/:itemId', requirePermission('Purchase Order', 'UPDATE'), (req, res, next) => controller.updatePurchaseOrderItem(req, res, next));
router.delete('/:id/items/:itemId', requirePermission('Purchase Order', 'UPDATE'), (req, res, next) => controller.deletePurchaseOrderItem(req, res, next));
