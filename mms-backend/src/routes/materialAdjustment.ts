...
router.post('/:id/items', requirePermission('Inventory Adjustment', 'UPDATE'), (req, res, next) => controller.addMaterialAdjustmentItem(req, res, next));
router.put('/:id/items/:itemId', requirePermission('Inventory Adjustment', 'UPDATE'), (req, res, next) => controller.updateMaterialAdjustmentItem(req, res, next));
router.delete('/:id/items/:itemId', requirePermission('Inventory Adjustment', 'UPDATE'), (req, res, next) => controller.deleteMaterialAdjustmentItem(req, res, next));
